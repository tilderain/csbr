...
//		sprite			  lvl  frm st ttl dmg spd  manset      sound
	...
	SPR_SHOT_BLADE_L1,		0,  0, 0, 29,  8, 0x0000,  0, SND_FIREBALL,		// Blade L1
	SPR_SHOT_BLADE_L2,		1,  0, 0, 40,  4,  0x0000,  0, SND_SLASH,		// Blade L2
	SPR_SHOT_BLADE_L3,		2,  0, 0, 40,  1,  0x0000,  0, SND_FIREBALL,		// Blade L3
	
	SPR_SHOT_SNAKE_L1,		0,  0, 1, 40,  3,  0x400,  2, SND_WAVER_FIRE,	// Snake L1
	SPR_SHOT_FIREBALL23,	1,	0, 1, 23,  2,  0x200,  2, SND_SNAKE_FIRE,	// Snake L2
	SPR_SHOT_FIREBALL23,	2,	0, 1, 60,  7,  0x200,  2, SND_FRONTIER_FIRE,	// Snake L3
	...
	SPR_SHOT_BUBBLER_L1,	0,	0, 0, 40,  1,  0x600,  2, SND_BUBBLER_FIRE,
	SPR_SHOT_BUBBLER_L2,	1,	0, 0, 60,  3,  0x600,  2, SND_BUBBLER_FIRE,
	SPR_SHOT_BUBBLER_L3,	2,	0, 0, 100, 2,  0x600,  2, SND_BUBBLER_FIRE,
