...
int tile;
	...
	//https://github.com/PIlin/NXEngine-iOS/commit/9e87e6a8f9105a3c9228cbeef415126f18019bed
...
void PRunSolidMushy(Object *o)
{
	...
	static const int REPEL_FORCE = 0x100;
...
int scr_x, scr_y;
	...
	if (!player->hurt_flash_state)
	{
		...
		{
			draw_sprite_at_dp_nonaligned(scr_x, scr_y, SPR_WATER_SHIELD, \
